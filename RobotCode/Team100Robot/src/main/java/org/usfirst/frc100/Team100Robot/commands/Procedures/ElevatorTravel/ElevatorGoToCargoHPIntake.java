...
import org.usfirst.frc100.Team100Robot.commands.Elevator.ElevatorLocations.ElevatorCargoHPIntake;
...
import org.usfirst.frc100.Team100Robot.commands.Elevator.ElevatorUpdateDesiredEndpoint.ElevatorUpdateDesiredSetpointLevel11;
...
public class ElevatorGoToCargoHPIntake extends CommandGroup {
  /**
   * Add your docs here.
   */
  public ElevatorGoToCargoHPIntake() {
    // Add Commands here:
    ...
    addSequential(new ElevatorUpdateDesiredSetpointLevel11());

    addSequential(new IntakeArmConditionalDown());
    addSequential(new ShoulderHatchIntake());

    addSequential(new ElevatorCargoHPIntake());
